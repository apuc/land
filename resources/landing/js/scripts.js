    ...
    btn.click(function () {
        ...
        if (isRadio == true && user == true && phone == true) {
            ...
            $.ajax({
                url: '/add-order',
                type: 'POST',
                data: {name: $("#customer_name").val(), phone: $("#customer_phone").val(), social_network: social_network},
                success: function () {
                },
                error: function () {
                }
    ...
    btn.click(function () {
        ...
        if (isRadio == true && $("#form-order .js-phone").val() != "" && $("#form-order .js-phone").val() != null) {
            ...
            if($("#whatsApp").prop("checked"))
                social_network = 'whatsApp';
            else if ($("#telegram").prop("checked"))
                social_network = 'telegram';
            else if ($("#viber").prop("checked"))
                social_network = 'viber';

            $.ajax({
                url: '/add-order',
                type: 'POST',
                data: {phone: $("#customer_phone1").val(), social_network: social_network},
                success: function () {
                },
                error: function () {
                }
