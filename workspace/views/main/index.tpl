                ...
                <div class="wrapper">
                    <div class="mistakes_block b1 js-mistakes-b1-animated animate__animated hidden">
                        <header>
                            ...
                            <p>Не копируйте чужой лендинг</p>
                        </header>
                        <footer>
                            <p>всегда можно сделать лучше!</p>
                        </footer>
                    </div>
                    ...
                    <div class="mistakes_block b2 js-mistakes-b2-animated animate__animated hidden">
                        <header>
                            ...
                            <p>Не используйте шаблоны</p>
                        </header>
                        <footer>
                            <p>возможно у клиента есть "плохой опыт" сотрудничества с компанией которая так же использовала этот шаблон?</p>
                        </footer>
                    </div>
                    ...
                    <div class="mistakes_block b3 js-mistakes-b3-animated animate__animated hidden">
                        ...
                        <footer>
                            <p>это будет стоить Вам высокой ценой конверсии!</p>
                        </footer>
                    </div>
                    ...
                    <div class="mistakes_block b4 js-mistakes-b4-animated animate__animated hidden">
                        <header>
                            ...
                            <p>Не доверяйте «недорогим методам»,</p>
                        </header>
                        <footer>
                            <p>которые не работают. Зачем платить дважды? Нет волшебной
                                красной кнопки со словом закажи,
                                которая даст конверсию 100%.</p>
                        </footer>
                    </div>
